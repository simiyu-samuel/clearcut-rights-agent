...
type ParsedReport = { title: string; metadata: Record<string, string>; notice: string; summaryRows: SummaryRow[]; details: ReportDetail[] };
  ...
  return (
    <section className="report-viewer panel">
      ...
      <div className="report-paper">
        ...
        <section className="report-section report-method"><div className="report-section-heading"><span>05</span><div><span>Method and limitations</span><h2>What this snapshot means</h2></div></div><div className="report-method-grid"><div><span>Evidence basis</span><strong>Stored source records and excerpts</strong><p>Sources are retained with their retrieval metadata for traceability.</p></div><div><span>Decision boundary</span><strong>Human approval remains required</strong><p>Recommendations support workflow; they do not grant legal rights.</p></div><div><span>Next review</span><strong>Before distribution</strong><p>Recheck unresolved or time-sensitive evidence before delivery.</p></div></div></section>
      </div>
    </section>
  );
}
