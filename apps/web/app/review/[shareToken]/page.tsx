...
export default async function ExternalReviewPage({ params }: SharePageProps) {
  ...
  return (
    <main className="external-review">
      <header className="external-review-header"><div className="report-cover-brand"><img className="report-cover-logo" src="/clearcut-logo.png" alt="ClearCut" /><span className="report-cover-brand-caption">Rights intelligence</span></div><span className="readiness-status conditional">Scoped external review</span></header>
